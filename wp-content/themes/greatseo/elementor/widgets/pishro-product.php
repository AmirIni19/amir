...
class Elementor_pishro_product extends \Elementor\Widget_Base {

    public function get_name() {
        return 'pishro_product';
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            'pishro_product_slide_number_tablet',
            [
        ...
        $this->add_control(
            'pishro_product_slide_number_mobile',
            [
        ...
        <script>
            $(function (){
                $('#product_slider_element').owlCarousel({
                    loop:<?php if ($settings['pishro_product_slide_loop']) {echo "true"; } else {echo "false"; } ?>,
                    margin:10,
                    nav:true,
                    responsive:{
                        0:{
                            items:<?php echo $settings['pishro_product_slide_number_mobile']; ?>
                        },
                        600:{
                            items:<?php echo $settings['pishro_product_slide_number_tablet']; ?>
                        },
                        1000:{
                            items:<?php echo $settings['pishro_product_slide_number']; ?>
                        }
                    },
                    dots:<?php if ($settings['pishro_product_slide_bullet']) {echo "true"; } else {echo "false"; } ?>,
                    autoplay:<?php if ($settings['pishro_product_slide_autoplay']) {echo "true"; } else {echo "false"; } ?>,
                    autoplayTimeout:<?php echo $settings['pishro_product_slide_speed']; ?>
                })
            });
            ...
            <div class="container">
                <div class="course-head">
                    <div class="course-title">
                        <h2><?php echo $settings['pishro_product_title']; ?></h2>
                        <h5><?php echo $settings['pishro_product_subtitle']; ?></h5>
                    </div>

                    <div class="course-link">
                        <a href="<?php echo $settings['pishro_product_btn_link']; ?>"><?php echo $settings['pishro_product_btn_title']; ?></a>
                    </div>
                </div>
                ...
                $pro = new WP_Query(array(
                    ...
                    'tax_query' => [[
                        'taxonomy'=> 'product_cat',
                        'field' => 'term_id',
                        'terms'=> $settings['pishro_select_product_cat'],
                    ]],
                ));
                if($pro->have_posts()) {
