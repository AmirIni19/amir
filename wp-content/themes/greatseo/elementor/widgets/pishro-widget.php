...
class Elementor_pishro_Widget extends \Elementor\Widget_Base {
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'input_type' => 'url',
                'placeholder' => 'پیشفرض websoft3.com است',
            ]
        );
        $this->add_control(
            'pishro_title',
            [
                ...
                'type' => \Elementor\Controls_Manager::TEXT,
                'input_type' => 'text',
                'placeholder' => 'پیشفرض وبسافت3 است',
            ]
        );
